...
function HospitalResetPasswordContent() {
          ...
          <CardContent className="p-6 text-center space-y-5">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-600 dark:text-slate-400 leading-5">
                {t("resetPassword.missingBody") ||
                  "This page expects a secure one-time token in the URL. Please return to the link sent by email, or request a new password reset."}
              </p>
            </div>
  ...
  return (
    <div className="w-full max-w-md mx-auto">
              ...
              <div>
                ...
                <p className="text-[11px] font-semibold text-slate-500 dark:text-slate-400 mt-1">
                  {t("resetPassword.subtitle") ||
                    "Medipaedia Clinical Gateway · One-time secure reset"}
                </p>
              </div>
            </div>
            <Badge
              variant="outline"
              className="text-[10px] font-black uppercase tracking-[0.18em] bg-white dark:bg-slate-900/80 border-teal-200 dark:border-teal-500/15 text-teal-700 dark:text-teal-300 px-2.5 py-0.5"
            >
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-[12px] leading-5 text-emerald-700/90 dark:text-emerald-200/80">
                    {t("resetPassword.successBody") ||
                      "Sign in below with your new credentials. Any active sessions on other devices have been signed out."}
                  </p>
                </div>
                <Button
                  type="button"
                  ...
                  className="mt-2"
                >
                  {t("resetPassword.signInCta") || "Continue to Sign In"}
                </Button>
              </div>
            </div>
          ) : (
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      placeholder="Apple#2024 · minimum 8 chars"
                      className="h-11 rounded-lg border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900/60 focus-visible:ring-teal-500/40 focus-visible:border-teal-500 text-slate-900 dark:text-white text-sm pr-10"
                      required
                    />
                    <button
                      type="button"
                      ...
                      className="absolute right-2.5 top-1/2 -translate-y-1/2 text-slate-500 hover:text-teal-600 dark:hover:text-teal-400"
      ...
      <div className="mt-4 text-center text-[10px] font-semibold text-slate-500 dark:text-slate-500">
        {t("resetPassword.securityFooter") ||
          "After a successful password change, you will be signed in on the next login; other sessions are signed out automatically."}
      </div>
    </div>
  );
}
